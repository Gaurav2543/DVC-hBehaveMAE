#!/bin/bash
#SBATCH --job-name=l4_extract_opt
#SBATCH --output=../generated_outputs/extract_opt_long4.out  # Save output logs
#SBATCH --error=../generated_outputs/extract_opt_long4.err   # Save error logs
...
python3 downstream_tasks/extract_embeddings_optimized4.py \
  ...
  --zarr_path /scratch/bhole/dvc_data/smoothed/models_4weeks/extract_opt_long_zarr4 \
  --output_dir /scratch/bhole/dvc_data/smoothed/models_4weeks/extract_opt_long4 \
