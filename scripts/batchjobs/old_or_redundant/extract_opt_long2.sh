#!/bin/bash
#SBATCH --job-name=l2_extract_opt
#SBATCH --output=../generated_outputs/extract_opt_long2.out  # Save output logs
#SBATCH --error=../generated_outputs/extract_opt_long2.err   # Save error logs
...
python3 downstream_tasks/extract_embeddings_optimized2.py \
  ...
  --zarr_path /scratch/bhole/dvc_data/smoothed/models_4weeks/extract_opt_long2_zarr \
  --output_dir /scratch/bhole/dvc_data/smoothed/models_4weeks/extract_opt_long2 \
