#!/bin/bash
#SBATCH --job-name=l3point75_extract_opt
#SBATCH --output=../generated_outputs/extract_opt_long3point75.out  # Save output logs
#SBATCH --error=../generated_outputs/extract_opt_long3point75.err   # Save error logs
...
python3 downstream_tasks/extract_embeddings_optimized3point5.py \
  ...
  --zarr_path /scratch/bhole/dvc_data/smoothed/models_4weeks/extract_opt_long3point75_zarr \
  --output_dir /scratch/bhole/dvc_data/smoothed/models_4weeks/extract_opt_long3point75 \
