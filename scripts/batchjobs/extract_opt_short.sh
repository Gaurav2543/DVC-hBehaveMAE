#!/bin/bash
#SBATCH --job-name=s_extract_opt
#SBATCH --output=../generated_outputs/extract_opt_short.out  # Save output logs
#SBATCH --error=../generated_outputs/extract_opt_short.err   # Save error logs
...
python3 downstream_tasks/extract_embeddings_optimized.py \
  ...
  --zarr_path /scratch/bhole/dvc_data/smoothed/models_3days/extract_opt_short_zarr \
  --output_dir /scratch/bhole/dvc_data/smoothed/models_3days/extract_opt_short \
