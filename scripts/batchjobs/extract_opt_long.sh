#!/bin/bash
#SBATCH --job-name=l_extract_opt
#SBATCH --output=../generated_outputs/extract_opt_long.out  # Save output logs
#SBATCH --error=../generated_outputs/extract_opt_long.err   # Save error logs
...
python3 downstream_tasks/extract_embeddings_optimized.py \
  ...
  --zarr_path /scratch/bhole/dvc_data/smoothed/models_4weeks/extract_opt_long_zarr \
  --output_dir /scratch/bhole/dvc_data/smoothed/models_4weeks/extract_opt_long \
