#!/bin/bash
#SBATCH --job-name=t_extract_embeds_zarr_short.sh
#SBATCH --output=../generated_outputs/extract_embeds_zarr_short_temp2.out  # Save output logs
#SBATCH --error=../generated_outputs/extract_embeds_zarr_short_temp2.err   # Save error logs
...
python3 downstream_tasks/extract_embeds_zarr_dask.py \
  ...
  --zarr_path /scratch/bhole/dvc_data/smoothed/models_3days/embeddings_zarr_short_temp2_out \
  --output_dir /scratch/bhole/dvc_data/smoothed/models_3days/embeddings_zarr_short_temp2 \
