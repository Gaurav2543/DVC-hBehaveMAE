#!/bin/bash
#SBATCH --job-name=opt_extract_embeds_short
#SBATCH --output=../generated_outputs/extract_embeds_optimized_short_10.out  # Save output logs
#SBATCH --error=../generated_outputs/extract_embeds_optimized_short_10.err   # Save error logs
...
python3 downstream_tasks/extract_embeds_optimized.py \
  ...
  --zarr_path /scratch/bhole/dvc_data/smoothed/models_3days/extract_embeds_optimized_shortttttt_zarr \
  --output_dir /scratch/bhole/dvc_data/smoothed/models_3days/extract_embeds_optimized_shorttttt \
