...
python3 downstream_tasks/extract_embeddings_fixed.py --dvc_root /scratch/bhole/dvc_data/smoothed/cage_activations_full_data_final \
    ...
    --output_dir /scratch/bhole/dvc_data/smoothed/models_4weeks/embeddings_fixed --time_aggregations 40320 \
    --aggregation_names 4weeks --batch_size 256 \
    --model hbehavemae \
