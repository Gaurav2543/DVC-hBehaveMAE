#!/bin/bash
#SBATCH --job-name=ml_extract_embed
#SBATCH --output=../generated_outputs/extract_embeds_fixed_long.out  # Save output logs
#SBATCH --error=../generated_outputs/extract_embeds_fixed_long.err   # Save error logs
...
python3 downstream_tasks/extract_embeddings_fixed.py \
  ...
  --output_dir /scratch/bhole/dvc_data/smoothed/models_4weeks/extract_embeds_fixed_long \
