...
common_args="--dataset dvc \
    --path_to_data_dir /scratch/bhole/dvc_data_smoothed/cage_activations \
    --batch_size 16384 \
    --model hbehavemae \
    ...
    --norm_loss False \
    --seed 0 \
    --output_dir /scratch/bhole/dvc_data_smoothed/models_3days \
    --log_dir logs \
    --normalization_method none" 
    # --precomputed_stats_path /scratch/bhole/z_score_stats/dvc_z_score.npz" 

torchrun --master_addr=127.0.0.1 --master_port=2996 train.py $common_args