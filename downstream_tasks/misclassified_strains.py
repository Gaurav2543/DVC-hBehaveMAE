...
class CompleteEmbeddingAnalyzer:
    ...
    def add_bodyweight_to_metadata(self):
        ...
        def process_single_row(row):
            ...
            # return self.match_bodyweight_to_timepoint(animal_ids, target_date, combined_bw, "closest")
    ...
    def load_and_prepare_data(self):
        """Load embeddings and metadata, create aligned dataset"""
...
#     def create_strain_misclassification_plot(self, y_true, y_pred, strain_names):
#         """Create strain misclassification stacked bar plot"""
#         print("Creating strain misclassification plot...")
