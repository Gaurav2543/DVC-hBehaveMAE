#!/bin/bash
#SBATCH --job-name=1week_normal_temp
#SBATCH --output=1week_normal_temp.out  # Save output logs
#SBATCH --error=1week_normal_temp.err   # Save error logs
...
python temp.py --dataset dvc \
    ...
    --pin_mem \
    --num_workers 4 \
    --output_dir /scratch/bhole/dvc_data_normal/models_1week \
    --summary_csv /scratch/bhole/dvc_data_normal/summary_files/10080_multithreaded/no_phenotyping_days_greater_than_10080_and_is_trusted_animal_10080.csv
